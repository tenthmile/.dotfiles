...
And define the color I want to use.
#+BEGIN_SRC emacs-lisp :tangle yes
  ;;(set-default 'cursor-type 'bar)

  (defvar my/cursor-color "#75B000") ;; bright and dark
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (defun dennis-set-cursor ()
    ...
    (set-cursor-color my/cursor-color) ;; set cursor color to green-ish color (bright)
